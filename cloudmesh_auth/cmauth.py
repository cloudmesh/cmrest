...
class CMAuthBasic(object):
    USERNAME = "fillmein"
    PASSWORD = "fillmein"
    NOTSOSECRETTOKEN = "dummytoken%correct%basicauth"
    ...
    def getToken(self, username, password):
        ...
        # change code bellow
        if username == CMAuthBasic.USERNAME and password == CMAuthBasic.PASSWORD:
            token = CMAuthBasic.NOTSOSECRETTOKEN
        return token
            
    def auth(self, idptype, idpendpoint, token):
        return token == CMAuthBasic.NOTSOSECRETTOKEN
